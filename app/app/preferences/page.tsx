...
import { PreferencesView } from "@/components/app/PreferencesView";

export const metadata = {
  title: "Preferences - Alias",
  description: "Customize your Alias experience with personal preferences.",
};
